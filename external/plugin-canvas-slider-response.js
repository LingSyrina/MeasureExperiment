var jsPsychCanvasSliderResponse = (function (jspsych) {
  ...
  class CanvasSliderResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      html += '">';
      html += '<input type="range" class="jspsych-slider" min="' + trial.min + '" max="' + trial.max + '" step="' + trial.step + '" style="width: 100%;" id="jspsych-canvas-slider-response-response" data-started="false">';
      html += "<div>";
      ...
      trial.stimulus(c);
      const sliderEl = display_element.querySelector("#jspsych-canvas-slider-response-response");
      if (sliderEl) {
        sliderEl.value = trial.min.toString();
        sliderEl.setAttribute("data-started", "false");
        sliderEl.classList.add("inactive-slider");
      }
      var response = {
        rt: null,
        response: null
      ...
      if (trial.require_movement) {
        const slider = display_element.querySelector("#jspsych-canvas-slider-response-response");
        const button = display_element.querySelector("#jspsych-canvas-slider-response-next");
